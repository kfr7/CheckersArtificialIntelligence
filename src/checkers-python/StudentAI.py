...
class StudentAI():
    ...
    def select_from_mcts(self):
        ...
        for i in range(NUMBER_OF_SIMULATIONS):
            ...
            all_child_score[simulate_start_move[0]][simulate_start_move[1]] += self.simulate(depth=1, max_depth=4) # since technically this was depth 0
            self.board.undo()
    ...
    def simulate(self, depth, max_depth):
        ...
        if self.board.is_win("W") != 0 or depth == max_depth:
            ...
            return (self.score() + average_value_after) / 2
